...
<!-- TODO: добавить в ISSUE про closing процессов-нод, что в рантайме, возможно, всё таки нужно понятие узла (обдумать связь с операторами)?

не забыть, что по завершении перевода этой главы стоит:
